...
class Pages(scrapy.Spider):
    name = "trustpilot"
    company = pd.read_csv("C:/Users/Acer/PycharmProjects/EndToEnd/final.csv")
    start_urls = company['company_url'].unique().tolist()
    ...
    def parse(self, response):
        ...
        company_website = response.xpath(
            "//a[@class='badge-card__section badge-card__section--hoverable']/@href").extract_first()
